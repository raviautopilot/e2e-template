...
Your production API project (e.g., `my-api`).
...
This E2E template project (the repo you cloned).
...
-   **Categorized HTML Report**: `evidence/<timestamp>/reports/report.html` (with File Category Tabs, Expected vs Actual Got, Diff Callouts).
-   **Markdown Test Summary**: `test-report.md`.
-   **Suite Documentation Markdown**: `docs/<test-file-name>.md` detailing every test written in that file, why it exists, expected vs got, and bug prevented.
...
Create fixtures inside this project.

Create:

-   Mock JSON files (`fixtures/<handler-name>/`)
-   Helper functions
-   Builders
-   Request creators
...
The generated tests MUST work with this execution flow from the project root:
...
10. Documentation file (`docs/<test-file-name>.md`)
11. File locations inside the project
